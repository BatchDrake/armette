...
uint32_t arm32_map_rw_buffer (struct arm32_cpu *, void *, size_t);
uint32_t arm32_map_ro_buffer (struct arm32_cpu *, void *, size_t);
uint32_t arm32_map_exec_buffer (struct arm32_cpu *, void *, size_t);
